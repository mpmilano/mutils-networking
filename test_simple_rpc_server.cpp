...
int main(int argc, char* argv[]){
	...
	conn_space::receiver{portno,[&](whendebug(std::ostream&,) connection& c){
				...
				struct ReceiverFun : public rpc::ReceiverFun {
...
#endif
					ReceiverFun(connection& c whendebug(, std::set<connection*> &used_connections))
						:c(c) whendebug(,used_connections(used_connections)){}
